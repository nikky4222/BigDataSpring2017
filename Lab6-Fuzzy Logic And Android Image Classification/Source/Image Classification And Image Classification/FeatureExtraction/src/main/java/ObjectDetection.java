...
class ObjectMainDetection {
  ...
  public ObjectMainDetection() throws IOException {
    ...
    public void StartVideo() throws IOException {
        Video<MBFImage> video = new XuggleVideo(new File("data/vid.mkv"));
    ...
    public void LoadReferenceObject() {
        ...
        try {
            modelImage1 = ImageUtilities.readMBF(new File("data/beaver.jpg"));
            modelImage2 = ImageUtilities.readMBF(new File("data/sealion.jpg"));
            modelImage3 = ImageUtilities.readMBF(new File("data/bird.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
